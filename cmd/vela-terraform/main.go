...
func main() {
	...
	app.Flags = []cli.Flag{
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/log_level,/vela/secrets/terraform/log_level"),
			Name:     "log.level",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/version,/vela/secrets/terraform/version"),
			Name:     "version",
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/parameters/apply/auto_approve,/vela/secrets/terraform/apply/back_up"),
		},
		&cli.StringFlag{
			Name:     "apply.back-up",
			Usage:    "path to backup the existing state file",
			EnvVars:  []string{"PARAMETER_BACK_UP"},
			FilePath: string("/vela/parameters/apply/back_up,/vela/secrets/terraform/apply/back_up"),
		},
		&cli.StringFlag{
			Name:     "apply.directory",
			Usage:    "the directory for action to be performed on",
			EnvVars:  []string{"PARAMETER_DIRECTORY"},
			FilePath: string("/vela/parameters/apply/directory,/vela/secrets/terraform/apply/directory"),
			Value:    ".",
		},
		&cli.BoolFlag{
			Name:     "apply.lock",
			...
			FilePath: string("/vela/parameters/apply/lock,/vela/secrets/terraform/apply/lock"),
		},
		&cli.DurationFlag{
			Name:     "apply.lock-timeout",
			Usage:    "duration to retry a state lock",
			EnvVars:  []string{"PARAMETER_LOCK_TIMEOUT"},
			FilePath: string("/vela/parameters/apply/lock_timeout,/vela/secrets/terraform/apply/lock_timeout"),
		},
		&cli.BoolFlag{
			Name:     "apply.no-color",
			Usage:    "disables colors in output",
			EnvVars:  []string{"PARAMETER_NO_COLOR"},
			FilePath: string("/vela/parameters/apply/no_color,/vela/secrets/terraform/apply/no_color"),
		},
		&cli.IntFlag{
			...
			FilePath: string("/vela/parameters/apply/parallelism,/vela/secrets/terraform/apply/parallelism"),
		},
		&cli.BoolFlag{
			Name:     "apply.refresh",
			Usage:    "update state prior to checking for differences",
			EnvVars:  []string{"PARAMETER_REFRESH"},
			FilePath: string("/vela/parameters/apply/refresh,/vela/secrets/terraform/apply/refresh"),
		},
		&cli.StringFlag{
			Name:     "apply.state",
			Usage:    "path to read and save state",
			EnvVars:  []string{"PARAMETER_STATE"},
			FilePath: string("/vela/parameters/apply/state,/vela/secrets/terraform/apply/state"),
		},
		&cli.StringFlag{
			Name:     "apply.state-out",
			Usage:    "path to write updated state file",
			EnvVars:  []string{"PARAMETER_STATE_OUT"},
			FilePath: string("/vela/parameters/apply/state_out,/vela/secrets/terraform/apply/state_out"),
		},
		&cli.StringFlag{
			Name:     "apply.target",
			Usage:    "resource to target",
			EnvVars:  []string{"PARAMETER_TARGET"},
			FilePath: string("/vela/parameters/apply/target,/vela/secrets/terraform/apply/target"),
		},
		&cli.StringSliceFlag{
			Name:     "apply.vars",
			Usage:    "a map of variables to pass to the Terraform (`<key>=<value>`)",
			EnvVars:  []string{"PARAMETER_VARS"},
			FilePath: string("/vela/parameters/apply/vars,/vela/secrets/terraform/apply/vars"),
		},
		&cli.StringSliceFlag{
			Name:     "apply.var_files",
			Usage:    "a list of var files to use",
			EnvVars:  []string{"PARAMETER_VAR_FILES"},
			FilePath: string("/vela/parameters/apply/var_files,/vela/secrets/terraform/apply/var_files"),
		},
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/config/action,/vela/secrets/terraform/config/action"),
		},
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/config/netrc/machine,/vela/secrets/terraform/config/netrc/machine"),
		},
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/config/netrc/username,/vela/secrets/terraform/config/netrc/username"),
		},
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/config/netrc/password,/vela/secrets/terraform/config/netrc/password"),
		},
		...
		&cli.BoolFlag{
			...
			Usage:    "skip interactive approval of running command",
			EnvVars:  []string{"PARAMETER_AUTO_APPROVE"},
			FilePath: string("/vela/parameters/destroy/auto_approve,/vela/secrets/terraform/destroy/auto_approve"),
		},
		&cli.StringFlag{
			Name:     "destroy.back-up",
			Usage:    "path to backup the existing state file",
			EnvVars:  []string{"PARAMETER_BACK_UP"},
			FilePath: string("/vela/parameters/destroy/back_up,/vela/secrets/terraform/destroy/back_up"),
		},
		&cli.StringFlag{
			Name:     "destroy.directory",
			Usage:    "the directory for action to be performed on",
			EnvVars:  []string{"PARAMETER_DIRECTORY"},
			FilePath: string("/vela/parameters/destroy/directory,/vela/secrets/terraform/destroy/directory"),
			Value:    ".",
		},
		&cli.BoolFlag{
			Name:     "destroy.lock",
			Usage:    "lock the state file when locking is supported",
			EnvVars:  []string{"PARAMETER_LOCK"},
			FilePath: string("/vela/parameters/destroy/lock,/vela/secrets/terraform/destroy/lock"),
		},
		&cli.DurationFlag{
			Name:     "destroy.lock-timeout",
			Usage:    "duration to retry a state lock",
			EnvVars:  []string{"PARAMETER_LOCK_TIMEOUT"},
			FilePath: string("/vela/parameters/destroy/lock_timeout,/vela/secrets/terraform/destroy/lock_timeout"),
		},
		&cli.BoolFlag{
			Name:     "destroy.no-color",
			Usage:    "disables colors in output",
			EnvVars:  []string{"PARAMETER_NO_COLOR"},
			FilePath: string("/vela/parameters/destroy/no_color,/vela/secrets/terraform/destroy/no_color"),
		},
		&cli.IntFlag{
			Name:     "destroy.parallelism",
			Usage:    "number of concurrent operations as Terraform walks its graph",
			EnvVars:  []string{"PARAMETER_PARALLELISM"},
			FilePath: string("/vela/parameters/destroy/parallelism,/vela/secrets/terraform/destroy/parallelism"),
		},
		&cli.BoolFlag{
			Name:     "destroy.refresh",
			Usage:    "update state prior to checking for differences",
			EnvVars:  []string{"PARAMETER_REFRESH"},
			FilePath: string("/vela/parameters/destroy/refresh,/vela/secrets/terraform/destroy/refresh"),
		},
		&cli.StringFlag{
			Name:     "destroy.state",
			Usage:    "path to read and save state",
			EnvVars:  []string{"PARAMETER_STATE"},
			FilePath: string("/vela/parameters/destroy/state,/vela/secrets/terraform/destroy/state"),
		},
		&cli.StringFlag{
			Name:     "destroy.state-out",
			Usage:    "path to write updated state file",
			EnvVars:  []string{"PARAMETER_STATE_OUT"},
			FilePath: string("/vela/parameters/destroy/state_out,/vela/secrets/terraform/destroy/state_out"),
		},
		&cli.StringFlag{
			Name:     "destroy.target",
			Usage:    "resource to target",
			EnvVars:  []string{"PARAMETER_TARGET"},
			FilePath: string("/vela/parameters/destroy/target,/vela/secrets/terraform/destroy/target"),
		},
		&cli.StringSliceFlag{
			Name:     "destroy.vars",
			Usage:    "a map of variables to pass to the Terraform (`<key>=<value>`)",
			EnvVars:  []string{"PARAMETER_VARS"},
			FilePath: string("/vela/parameters/destroy/vars,/vela/secrets/terraform/destroy/vars"),
		},
		&cli.StringSliceFlag{
			Name:     "destroy.var_files",
			Usage:    "a list of var files to use",
			EnvVars:  []string{"PARAMETER_VAR_FILES"},
			FilePath: string("/vela/parameters/destroy/var_files,/vela/secrets/terraform/destroy/var_files"),
		},
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/parameters/fmt/check,/vela/secrets/terraform/fmt/check"),
		},
		&cli.BoolFlag{
			Name:     "fmt.diff",
			Usage:    "diffs of formatting changes",
			EnvVars:  []string{"PARAMETER_DIFF"},
			FilePath: string("/vela/parameters/fmt/diff,/vela/secrets/terraform/fmt/diff"),
		},
		&cli.StringFlag{
			Name:     "fmt.directory",
			Usage:    "the directory for action to be performed on",
			EnvVars:  []string{"PARAMETER_DIRECTORY"},
			FilePath: string("/vela/parameters/fmt/directory,/vela/secrets/terraform/fmt/directory"),
			Value:    ".",
		},
		&cli.BoolFlag{
			Name:     "fmt.list",
			...
			FilePath: string("/vela/parameters/fmt/list,/vela/secrets/terraform/fmt/list"),
		},
		&cli.BoolFlag{
			Name:     "fmt.write",
			Usage:    "write result to source file instead of STDOUT",
			EnvVars:  []string{"PARAMETER_WRITE"},
			FilePath: string("/vela/parameters/fmt/write,/vela/secrets/terraform/fmt/write"),
		},
		...
		&cli.StringFlag{
			...
			Usage:    "the directory for action to be performed on",
			EnvVars:  []string{"PARAMETER_DIRECTORY"},
			FilePath: string("/vela/parameters/init/directory,/vela/secrets/terraform/fmt/directory"),
			Value:    ".",
		},
		&cli.StringFlag{
			Name:     "init.options",
			...
			FilePath: string("/vela/parameters/init/options,/vela/secrets/terraform/fmt/options"),
		},
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/parameters/plan/destroy,/vela/secrets/terraform/plan/destroy"),
		},
		&cli.BoolFlag{
			...
			FilePath: string("/vela/parameters/plan/detailed_exit_code,/vela/secrets/terraform/plan/detailed_exit_code"),
		},
		&cli.StringFlag{
			Name:     "plan.directory",
			Usage:    "the directory for action to be performed on",
			EnvVars:  []string{"PARAMETER_DIRECTORY"},
			FilePath: string("/vela/parameters/plan/directory,/vela/secrets/terraform/plan/directory"),
			Value:    ".",
		},
		&cli.BoolFlag{
			Name:     "plan.lock",
			Usage:    "lock the state file when locking is supported",
			EnvVars:  []string{"PARAMETER_LOCK"},
			FilePath: string("/vela/parameters/plan/lock,/vela/secrets/terraform/plan/lock"),
		},
		&cli.DurationFlag{
			Name:     "plan.lock-timeout",
			Usage:    "duration to retry a state lock",
			EnvVars:  []string{"PARAMETER_LOCK_TIMEOUT"},
			FilePath: string("/vela/parameters/plan/lock_timeout,/vela/secrets/terraform/plan/lock_timeout"),
		},
		&cli.IntFlag{
			Name:     "plan.module-depth",
			Usage:    "specifies the depth of modules to show in the output",
			EnvVars:  []string{"PARAMETER_MODULE_DEPTH"},
			FilePath: string("/vela/parameters/plan/module_depth,/vela/secrets/terraform/plan/module_depth"),
		},
		&cli.BoolFlag{
			Name:     "plan.no-color",
			Usage:    "disables colors in output",
			EnvVars:  []string{"PARAMETER_NO_COLOR"},
			FilePath: string("/vela/parameters/plan/no_color,/vela/secrets/terraform/plan/no_color"),
		},
		&cli.IntFlag{
			Name:     "plan.parallelism",
			Usage:    "number of concurrent operations as Terraform walks its graph",
			EnvVars:  []string{"PARAMETER_PARALLELISM"},
			FilePath: string("/vela/parameters/plan/parallelism,/vela/secrets/terraform/plan/parallelism"),
		},
		&cli.BoolFlag{
			Name:     "plan.refresh",
			Usage:    "update state prior to checking for differences",
			EnvVars:  []string{"PARAMETER_REFRESH"},
			FilePath: string("/vela/parameters/plan/refresh,/vela/secrets/terraform/plan/refresh"),
		},
		&cli.StringFlag{
			Name:     "plan.state",
			Usage:    "path to read and save state",
			EnvVars:  []string{"PARAMETER_STATE"},
			FilePath: string("/vela/parameters/plan/state,/vela/secrets/terraform/plan/state"),
		},
		&cli.StringFlag{
			Name:     "plan.state-out",
			Usage:    "path to write updated state file",
			EnvVars:  []string{"PARAMETER_STATE_OUT"},
			FilePath: string("/vela/parameters/plan/state_out,/vela/secrets/terraform/plan/state_out"),
		},
		&cli.StringFlag{
			Name:     "plan.target",
			Usage:    "resource to target",
			EnvVars:  []string{"PARAMETER_TARGET"},
			FilePath: string("/vela/parameters/plan/target,/vela/secrets/terraform/plan/target"),
		},
		&cli.StringSliceFlag{
			Name:     "plan.vars",
			Usage:    "a map of variables to pass to the Terraform (`<key>=<value>`)",
			EnvVars:  []string{"PARAMETER_VARS"},
			FilePath: string("/vela/parameters/plan/vars,/vela/secrets/terraform/plan/vars"),
		},
		&cli.StringSliceFlag{
			Name:     "plan.var_files",
			Usage:    "a list of var files to use",
			EnvVars:  []string{"PARAMETER_VAR_FILES"},
			FilePath: string("/vela/parameters/plan/var_files,/vela/secrets/terraform/plan/var_files"),
		},
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/parameters/validation/check_variables,/vela/secrets/terraform/validation/check_variables"),
		},
		&cli.StringFlag{
			Name:     "validation.directory",
			Usage:    "the directory for action to be performed on",
			EnvVars:  []string{"PARAMETER_DIRECTORY"},
			FilePath: string("/vela/parameters/validation/directory,/vela/secrets/terraform/validation/directory"),
			Value:    ".",
		},
		&cli.BoolFlag{
			...
			Usage:    "disables colors in output",
			EnvVars:  []string{"PARAMETER_NO_COLOR"},
			FilePath: string("/vela/parameters/validation/no_color,/vela/secrets/terraform/validation/no_color"),
		},
		&cli.StringSliceFlag{
			Name:     "validation.vars",
			Usage:    "a map of variables to pass to the Terraform (`<key>=<value>`)",
			EnvVars:  []string{"PARAMETER_VARS"},
			FilePath: string("/vela/parameters/validation/vars,/vela/secrets/terraform/validation/vars"),
		},
		&cli.StringSliceFlag{
			Name:     "validation.var_files",
			Usage:    "a list of var files to use",
			EnvVars:  []string{"PARAMETER_VAR_FILES"},
			FilePath: string("/vela/parameters/validation/var_files,/vela/secrets/terraform/validation/var_files"),
		},
	}
