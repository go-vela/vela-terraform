...
LD_FLAGS = -X github.com/go-vela/vela-terraform/version.Commit=${GITHUB_SHA} -X github.com/go-vela/vela-terraform/version.Date=${BUILD_DATE} -X github.com/go-vela/vela-terraform/version.Go=${GOLANG_VERSION} -X github.com/go-vela/vela-terraform/version.Tag=${GITHUB_TAG}
...
docker-run:
	...
	@docker run --rm \
		-e PARAMETER_ACTION \
		-e PARAMETER_AUTO_APPROVE \
		-e PARAMETER_BACK_UP \
		-e PARAMETER_CHECK \
		-e PARAMETER_CHECK_VARIABLES \
		-e PARAMETER_DESTROY \
		-e PARAMETER_DETAILED_EXIT_CODE \
		-e PARAMETER_DIFF \
		-e PARAMETER_DIRECTORY \
		-e PARAMETER_INIT_OPTIONS \
		-e PARAMETER_LIST \
		-e PARAMETER_LOCK \
		-e PARAMETER_LOCK_TIMEOUT \
		-e PARAMETER_MODULE_DEPTH \
		-e PARAMETER_NO_COLOR \
		-e PARAMETER_PARALLELISM \
		-e PARAMETER_REFRESH \
		-e PARAMETER_STATE \
		-e PARAMETER_STATE_OUT \
		-e PARAMETER_TARGET \
		-e PARAMETER_VARS \
		-e PARAMETER_VAR_FILES \
		-e PARAMETER_WRITE \
